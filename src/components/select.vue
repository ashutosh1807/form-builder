<template>
   <div class="sel draggable" v-if="vis" style="position:absolute;">
      ...
      <br>
      <span class="innersel">
         <select :style="Style" :name="name" class="custom-select">
        ...
        <b-modal title="Edit Select Option"  header-bg-variant="success"  header-text-variant="light"  ref="inp" >
